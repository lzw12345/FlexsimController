...
public class OutputAnalysisCalculation {
    ...
    public static HashMap<String, Double> calculateAverageProductCycleTime(Sheet productCycleTimeSheet) {
     ...
     * @throws IOException
     */
    public static HashMap<String, Double> calculateAverageIbisOvenUtilRate(Sheet utilizationSheet) {
